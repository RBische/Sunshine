...
import fr.bischof.raphael.sunshine.data.WeatherContract.WeatherEntry;
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                mContext.getContentResolver().bulkInsert(WeatherEntry.buildWeatherUri(0),cVVector.toArray(new ContentValues[cVVector.size()]));
            }
